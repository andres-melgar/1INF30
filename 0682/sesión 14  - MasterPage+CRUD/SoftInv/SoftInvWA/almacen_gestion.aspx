...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">
    <div class="card">
        ...
        <div class="card-body">
            <div class="mb-3 row">
                <asp:Label ID="lblIdAlmacen" runat="server" Text ="Id Almacén: "
                    CssClass="col-sm-4 col-form-label"></asp:Label>
                <div class="col-sm-4">
                    <asp:TextBox ID="txtIdAlmacen" Enabled="false" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
            </div>
            <div class="mb-3 row">
                <asp:Label ID="lblNombre" runat="server" Text ="Nombre Almacén: "
                    CssClass="col-sm-4 col-form-label"></asp:Label>
                <div class="col-sm-4">
            ...
            <div class="mb-3 row">
                <asp:Label ID="lblCentral" runat="server" Text ="¿Almacén central?: "
                    CssClass="col-sm-4 col-form-label"></asp:Label>
                <div class="col-sm-4">
