    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                <div class="card border">
                    <div class="card-header bg-light">
                        <h5 class="card-title mb-0">Información del Tipo de Producto</h5>
                    </div>
                    <div class="card-body">
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            <asp:Label ID="lblTipoProductoNombre" runat="server" Text="Nombre:" CssClass="col-sm-2 col-form-label" />
                            <div class="col-sm-8">
                                <asp:TextBox ID="txtTipoProductoNombre" runat="server" Enabled="false" CssClass="form-control" />
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <asp:Label ID="lblTipoProductoDescripcion" runat="server" Text="Nombre:" CssClass="col-sm-2 col-form-label" />
                            <div class="col-sm-8">
                                <asp:TextBox ID="txtTipoProductoDescripcion" runat="server" Enabled="false" CssClass="form-control" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-footer clearfix">
                <asp:Button ID="btnRegresar" runat="server" Text="Regresar" CssClass="float-start btn btn-secondary"/>
            </div>
        </div>
    </div>

    <%-- incluimos soporte AJAX --%>
                        ...
                        <ContentTemplate>
                            <div class="container row pb-3 pt-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-2">
                                        <asp:LinkButton ID="ModalTipoProducto_lbBuscarTipoProducto" runat="server" CssClass="btn btn-info" Text="<i class='fa-solid fa-magnifying-glass pe-2'></i> Buscar" OnClick="ModalTipoProducto_lbBuscarTipoProducto_Click" />
                                    </div>
                                </div>
                                <div class="container row">
                                    <asp:GridView ID="ModalTipoProducto_gvTipoProductos" runat="server" AllowPaging="false" AutoGenerateColumns="false" CssClass="table table-hover table-responsive table-striped">
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:LinkButton ID="ModalTipoProducto_lbSeleccionar" class="btn btn-success" runat="server" Text="<i class='fa-solid fa-check ps-2'></i> Seleccionar"  CommandArgument='<%# Eval("TipoProductoId") %>' OnClick="ModalTipoProducto_lbSeleccionar_Click" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
