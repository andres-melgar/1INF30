...
import pe.edu.pucp.softven.reports.ReporteUtil;
...
public class Productos {
    ...
    public byte[] reporteVendedores() {
        return ReporteUtil.reporteVendedores();
    }
    
    @WebMethod(operationName = "reporteTiendas")
    public byte[] reporteTiendas(@WebParam(name = "pTiendaId") Integer pTiendaId) {
        return ReporteUtil.reporteTiendas(pTiendaId);
    }
}
